...
ZN_HttpRouter *ZN_HttpRouter_New(void){
	ZN_HttpRouter *http_route_manager=ZN_NEW(ZN_HttpRouter);
	ZN_HttpRouterData *data=ZN_NEW(ZN_HttpRouterData);
...
void ZN_HttpRouter_AddRoute(ZN_HttpRouter * _this, const char *_url,const char *_path,ZN_HttpResponseCallback  *_on_request){
	ZN_HttpRouterData *data=_this->data;
	ZN_HttpRoute *route=ZN_HttpRoute_New(_url,_path, _on_request);
	ZN_List_Add(data->routes,route);
}

ZN_HttpRoute *ZN_HttpRouter_SearchRoute(ZN_HttpRouter * _this, const char *_url){
	ZN_HttpRouterData *data=_this->data;
