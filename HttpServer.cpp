...
HttpServer::HttpServer(){
	...
	// by default..
	this->LOGO_BASE64="";
	//this.gest_message_action = _gest_message_action;
	web_client = NULL;
}
 ...
 void HttpServer::setup(int _port
		...
		//this.gest_message_action = _gest_message_action;
		web_client = NULL;
		this->setupAsServer(_port,_port,this->NAME.c_str());

 }

void  HttpServer::SetLogoBase64(string _image_base_64)
{
	LOGO_BASE64 = _image_base_64;
}

bool HttpServer::gestMessage(void *socket, Uint8 *data, unsigned int size){
...
void HttpServer::onGetUserRequest(TCPsocket  _socket_client,const vector<HttpRequest::tParamValue> & param){
