...
void ZN_HttpHandleConnection_DoHandle(ZN_HttpHandleConnection *_http_handle_client)
{
	//std::string msg = "";
	...
	ZN_HttpHandleConnection_Delete(_http_handle_client);

}

void ZN_HttpHandleConnection_Delete(ZN_HttpHandleConnection *_http_handle_client){
