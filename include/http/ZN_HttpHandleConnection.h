...
struct ZN_HttpHandleConnection
{
	...
	size_t    				rcv_buffer_data_len;
};

ZN_HttpHandleConnection * ZN_HttpHandleConnection_New(ZN_TcpServerClient * _socket_client, ZN_HttpServer *http_server, uint8_t *_rcv_data, size_t _rcv_data_len);
