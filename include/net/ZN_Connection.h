...
ZN_DLL_EXPORT ssize_t 	ZN_Connection_Write(ZN_Connection *c, const uint8_t *data, int len);
ZN_DLL_EXPORT ssize_t	ZN_Connection_Read(ZN_Connection *c, uint8_t *buf, int len);
